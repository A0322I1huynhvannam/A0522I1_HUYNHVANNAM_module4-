...
<form:form modelAttribute="toKhaiYTe" action="/add" method="post">
  <fieldset>
    ...
    <table>
      ...
      <tr>
        <td><form:label path="phuongTien">Thong tien di lai:(*) </form:label></td>
        <td><form:radiobuttons path="phuongTien" items="${phuongTien}"/></td>
      </tr>
      <tr>
        <td><form:label path="soHieu">So Hieu Phuong tien:(*) </form:label></td>
